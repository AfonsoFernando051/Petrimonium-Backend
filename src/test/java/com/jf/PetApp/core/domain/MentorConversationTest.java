...
class MentorConversationTest {
    ...
    void accessors_ReturnConstructedValues() {
        ...
        MentorConversation conversation = new MentorConversation(1L, "user@test.com", "My Chat", created, updated);
    ...
    void title_CanBeNullBeforeFirstMessage() {
        ...
        MentorConversation conversation = new MentorConversation(1L, "user@test.com", null, now, now);
